...
/**
 * @brief Uses the Mersenne Twister Engine for shuffling.
 *
 * This function uses the Mersenne Twister Engine to shuffle the first and last iterator.
 *
 * @return void.
 * @param first The first iterator.
 * @param last The last iterator.
 * @param g Some reference to an object of mt19937 that I am not completely sure about.
 * @todo Need to understand what the object means.
 */
...
/**
 * @brief Creates Middle-Earth.
 *
 * This function is a constructor and creates Middle-Earth with the given parameters.
 *
 * @return This is a constructor so it returns a new instance of Middle-Earth.
 * @param xsize The size in the x direction.
 * @param ysize The size in the y direction.
 * @param num_cities The number of cities.
 * @param seed The seed for generating Middle-Earth.
 */
 ...
 * @brief Print Method.
 *
 * This function prints all the information on the new world that was created.
 *
 * @return void.
 */
 ...
 * @brief Table Printer.
 *
 * This function prints the table of the distances for each of the cities.
 *
 * @return void.
 */
 ...
 *
 * This function computes the distance between two cities. This function is also constant.
 *
 * @return The float value of the distance between two cities.
...
/**
 * @brief Computes the itinerary that was travelled.
 *
 * This function creates a vector of strings that serves as the itinerary for Middle-Earth. In other words, it lists the 
 * destinations that should be travelled in Middle-Earth.
 *
 * @return The vector of strings that lists all the places.
 * @param length The length of travel.
 */
