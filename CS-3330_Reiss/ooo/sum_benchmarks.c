...
function_info functions[] = {
    ...
    // ADD ENTRIES HERE!
	{sum_unrolled2, "sum_unrolled2: sum_simple but with 2 iterations"},
	{sum_unrolled4, "sum_unrolled4: sum_unrolled4 but with 4 iterations"},  
	{sum_multiple_accum, "sum_multiple_accum: uses four accumulators"},	
	{sum_multiple_accum_C, "sum_multipple_accum_C: four accumulators with c"},
