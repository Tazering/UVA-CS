...
unsigned short sum_AVX(long size, unsigned short *a) {
   ...
   for (int i = 0; i < size; i += 16) {
        ...
        partial_sums = _mm256_add_epi16(partial_sums, vecA);
    }
    ...
    extracted_partial_sums[3] + extracted_partial_sums[4] + extracted_partial_sums[5] + extracted_partial_sums[6] +
    extracted_partial_sums[7] + extracted_partial_sums[8] + extracted_partial_sums[9] + extracted_partial_sums[10] +
    extracted_partial_sums[11] + extracted_partial_sums[12] + extracted_partial_sums[13] +
    extracted_partial_sums[14] + extracted_partial_sums[15];
}
